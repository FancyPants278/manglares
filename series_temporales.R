...
nl_comitan$region <- rep("Comitán", nrow(nl_comitan))
...
nl_enfermeria$region <- rep("Enfermería", nrow(nl_enfermeria))
...
ndvi$region <- factor(ndvi$region, levels = c("Aeropuerto-Fidepaz","La Ardilla", "Balandra", "El Cajoncito", "El Centenario", "Chametla", "Comitán", "El Conchalito", "Enfermería", "Eréndira", "Espíritu Santo", "El Merito", "El Mogote", "Palmira", "Unidad Pichilingue", "El Tesoro", "El Zacatal", "Zacatecas"))
...
wl_comitan$region <- rep("Comitán", nrow(wl_comitan))
...
wl_enfermeria$region <- rep("Enfermería", nrow(wl_enfermeria))
...
ndwi$region <- factor(ndwi$region, levels = c("Aeropuerto-Fidepaz","La Ardilla", "Balandra", "El Cajoncito", "El Centenario", "Chametla", "Comitán", "El Conchalito", "Enfermería", "Eréndira", "Espíritu Santo", "El Merito", "El Mogote", "Palmira", "Unidad Pichilingue", "El Tesoro", "El Zacatal", "Zacatecas"))
...
ll_comitan$region <- rep("Comitán", nrow(ll_comitan))
...
ll_enfermeria$region <- rep("Enfermería", nrow(ll_enfermeria))
...
lswi$region <- factor(lswi$region, levels = c("Aeropuerto-Fidepaz","La Ardilla", "Balandra", "El Cajoncito", "El Centenario", "Chametla", "Comitán", "El Conchalito", "Enfermería", "Eréndira", "Espíritu Santo", "El Merito", "El Mogote", "Palmira", "Unidad Pichilingue", "El Tesoro", "El Zacatal", "Zacatecas"))
...
p_comitan$region <- rep("Comitán", nrow(p_comitan))
...
rain$region <- factor(rain$region, levels = c("Aeropuerto-Fidepaz","La Ardilla", "Balandra", "El Cajoncito", "El Centenario", "Chametla", "Comitán", "El Conchalito", "Enfermería", "Eréndira", "Espíritu Santo", "El Merito", "El Mogote", "Palmira", "Unidad Pichilingue", "El Tesoro", "El Zacatal", "Zacatecas"))
...
#$region <- rep("Comitán", nrow(t_comitan))
...
temp$region <- factor(temp$region, levels = c("Aeropuerto-Fidepaz","La Ardilla", "Balandra", "El Cajoncito", "El Centenario", "Chametla","El Conchalito", "Enfermería", "Eréndira", "Espíritu Santo", "El Merito", "El Mogote", "Palmira", "Unidad Pichilingue", "El Tesoro", "El Zacatal", "Zacatecas"))
